...
module.exports.getNewRandomLine = function () {   //new function to know which line was prevoiulsy generated and to not generate it again this time

  let index = randomInt(0, array.length);
  let cnt=Number(array.length);
  while(!viewed.includes(index)&&cnt>=0)  //might get executed in  1 iteration or might take log(n) iterations if used more in a day
  {
